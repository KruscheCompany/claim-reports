					...
					<table>
						<thead>
							<tr class="table100-head">
								<th class="column1">Priority</th>
								<th class="column2">URL</th>
								<th class="column3">CVE</th>
							</tr>
						</thead>
						<tbody>
"""
...
for x in data:
  ...
  if x['priority'] == "High":
    ...
    color = 'green'
  	...
  	color = "grey"
  file.write( "<td class='column1'><font color='" + color + "'><strong>" + x['priority'] + "</strong></font></td><td class='column2'>" + x['url'] + "</td><td class='column3'>" + x['cve'] + "</td>")
  file.write('<tr>')
